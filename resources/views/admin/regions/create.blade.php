    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.regions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('denj') ? 'is-invalid' : '' }}" type="text" name="denj" id="denj" value="{{ old('denj', '') }}">
                @if($errors->has('denj'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mnemonic') ? 'is-invalid' : '' }}" type="text" name="mnemonic" id="mnemonic" value="{{ old('mnemonic', '') }}">
