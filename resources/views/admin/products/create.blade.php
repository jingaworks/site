    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_starts') ? 'is-invalid' : '' }}" type="number" name="price_starts" id="price_starts" value="{{ old('price_starts', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_ends">{{ trans('cruds.product.fields.price_ends') }}</label>
                <input class="form-control {{ $errors->has('price_ends') ? 'is-invalid' : '' }}" type="number" name="price_ends" id="price_ends" value="{{ old('price_ends', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="region_id">{{ trans('cruds.product.fields.region') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="place_id">{{ trans('cruds.product.fields.place') }}</label>
